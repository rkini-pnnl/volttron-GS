    ...
    def publish_report(self):
        ...
        message = [
            {'excess_operation': bool(self.excess_operation),
             'all_condition_true_time': int(self.all_condition_true_time.total_seconds())
             },
            {'excess_operation': {'units': 's', 'tz': 'UTC', 'data_type': 'bool'},
             'all_condition_true_time': {'units': 'seconds', 'tz': 'UTC', 'data_type': 'integer'}
             }
        ]
